  ...
  export default {
    ...
    methods: {
      checkConnection() {
        ...
        let apiUrl = store.apiUri + this.uri + '/checkConnection'

        dashboardRequest.get(apiUrl)
          .then( response => {
      ...
      boostrapDashboard() {
        ...
        let dashboardRequest = new Form( {}, true )
        let apiUrl = store.apiUri + this.uri + '/totalNumberOfUsers'
        dashboardRequest.get(apiUrl)
          .then( response => {
            component.totalUsers = response.data.data
          })

        apiUrl = store.apiUri + this.uri + '/totalNumberOfMigratedUsers'
        dashboardRequest.get(apiUrl)
          .then( response => {
            component.migratedUsers = response.data.data
          })

        apiUrl = store.apiUri + this.uri + '/totalNumberOfUsers/destination'
        dashboardRequest.get(apiUrl)
          .then( response => {
            component.totalUsersInDestination = response.data.data
          })

        apiUrl = store.apiUri + this.uri + '/totalNumberOfMigratedUsers/destination'
        dashboardRequest.get(apiUrl)
          .then( response => {
